...
?>
    <td bgcolor="#FFCC33">
      ...
      <table border="0" cellspacing="0" cellpadding="3" width="100%" bgcolor="#7B7B7B" >
        ...
        <tr align="right" bgcolor="#FFCC33">
          <td>
            <p><a href="<?php echo $top_level; ?>info_plat.php.es" class="menus">Información</a>
            <br><a href="<?php echo $top_level; ?>supp_deve.php.es" class="menus">Desarrollo de Open Source</a>
            <br><a href="<?php echo $top_level; ?>pres_plat.php.es" class="menus">Presentación</a>
          </td>
        </tr>
      </table>
      <p>
      ...
      <table border="0" cellspacing="0" cellpadding="3" width="100%" bgcolor="#7B7B7B" >
        ...
        <tr align="right" bgcolor="#FFCC33">
          <td>
            ...
            <br><a href="http://oss-broschuere.berlios.de/" class="menus">OSS Broschure</a>
