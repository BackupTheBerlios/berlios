...
<p>Uno de los objetivos de la plataforma BerliOS es apoyar los  desarrollos de software libre (Open Source) mediante servicios en línea como sistemas de control de versiones, listas de correo, sistemas de control de erratas y otras funcionalidades. BerliOS pretende ayudar en todos los aspectos del desarrollo de software libre (Open Source).

<p>El portal principal para llevar esto a cabo es <a href="http://developer.berlios.de">Developer</a>. Developer está basado en la versión 1.5 de <a href="http://sourceforge.net">SourceForge</a> y provee servicios como la gestión de versiones, listas de correo, sistema de control de erratas, documentación y parches, etc. etc.
