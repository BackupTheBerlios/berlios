...
// http://www.berlios.de
//
// $Id: group_donations.php,v 1.1 2004/04/02 10:40:21 helix Exp $

require "pre.php";    
session_require(array('group'=>'1','admin_flags'=>'A'));
$HTML->header(array('title'=>'Alexandria: Project Donations'));
...
if ($action=='pending') {
	...
	echo '<p>Group Donation from '.$user_id.' at '.date($sys_datefmt,$date).' ('.$date.') is changed to PENDING';
}
...
<?php
  for ($i=0; $i<$rows; $i++) {
	...
	print '<td valign="top" align="right">'. db_result($res,$i,'to_group_id') .'</td>';
