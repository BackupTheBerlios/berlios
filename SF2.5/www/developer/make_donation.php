...
//
// $Id: make_donation.php,v 1.1 2004/04/02 10:42:24 helix Exp $
...
$res_don=db_query("SELECT * FROM user_donate WHERE user_id='".$user_id."'");
...
if (isset($amt)) {
?>
<form action="userdonation.php" method="post">
<h2>Thank you for offering your donation of &euro;<?php echo $amt; ?>,00 to <a href="/users/<?php echo $user->getUnixName() ?>"><?php echo $user->getUnixName() ?></a>.</h2>
<p>If you want your name (and comment) to appear on my public <a href="/developer/donations.php?user_id=<?php echo $user_id; ?>" target="_blank">Supporters page</a>,
...
<h2 align="center">Click on one of the PayPal buttons below to donate money to <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a>.</h2>

<center>
<table width="100%">
<tbody><tr>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=5"><img src="/images/x-click-but7.gif" alt="[Donate &euro;5,00 EUR]" border="0"></a></td>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=10"><img src="/images/x-click-but7.gif" alt="[Donate &euro;10,00 EUR]" border="0"></a></td>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=20"><img src="/images/x-click-but7.gif" alt="[Donate &euro;20,00 EUR]" border="0"></a></td>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=50"><img src="/images/x-click-but7.gif" alt="[Donate &euro;50,00 EUR]" border="0"></a></td>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=100"><img src="/images/x-click-but7.gif" alt="[Donate &euro;100,00 EUR]" border="0"></a></td>
<td align="center"><a href="?user_id=<?php echo $user_id; ?>&amt=250"><img src="/images/x-click-but7.gif" alt="[Donate &euro;250,00 EUR]" border="0"></a></td>
</tr>
<tr>
...
<p>Information provided (by this user) about donations:</p>
...
<blockquote>
      <div style="padding: 4px; background-color: rgb(221, 221, 221); color: rgb(0, 0, 0);">
        <ul>
          <li><a href="#why">Why should I donate money to <?php echo $user->getUnixName(); ?> and how will the money be used?</a></li>
	      <li><a href="#how">How do I donate money to <?php echo $user->getUnixName(); ?>
...
<p><a name="why"><br></a><b>Why should I donate money to <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a>?</b>
</p>
<blockquote>
<p><a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a> has provided the following information about why you should donate money to her/him, and how your donation will be used:
</p>
<p><?php echo $comment; ?>
</p></blockquote>

<p><a name="how"><br></a><b>How do I donate money to <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a>?</b>

<blockquote>
<p>At the <a href="#donate">bottom of this page</a>, you are provided the opportunity to proceed in donating money to <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a>. BerliOS Developer accepts donations using <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_help-ext&source_page=_help-ext">PayPal</a>.  This process has the following steps:

<ol>
  <li><b>At the <a href="#donate">bottom of this page</a>, click on the button above the amount you want to donate.</b> Go to the Donation Page (you are here, now), read the provided instructions and use one of the PayPal buttons at the bottom of the page select the size of the donation you want to make to the BerliOS Developer <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a>. Buttons are provided for common denominations of &euro;5, &euro;10, &euro;20, &euro;50, &euro;100, and &euro;250.</li>
  <li><b>Enter a comment if you want to appear on the <a href="/developer/donations.php?user_id=<?php echo $user_id; ?>">Supporters page for <?php echo $user->getUnixName(); ?></a>, then click the PayPal Donate button.</b> After clicking on one of the denomination buttons, you will be offered the opportunity to verify that you have picked the desired denomination, and to enter a comment that will be attached to this donation. To proceed, click on the PayPal Donate button.</li>
  ...
  <li><b>Track your donations.</b> Once your donation has been submitted, PayPal will email you a receipt.  The BerliOS Developer site will recognize your donation within a week. If you entered a comment on the donation page, that comment will appear on the <a href="/developer/donations.php?user_id=<?php echo $user_id; ?>">Supporters page for <?php echo $user->getUnixName(); ?></a>. A listing of donations you have made will also appear in the Donations section of the your Developer Profile page.</li>
</ol>
</blockquote>
...
<hr><a name="donate"></a><h2 align="center">Select the amount to donate to <a href="/users/<?php echo $user->getUnixName(); ?>"><?php echo $user->getUnixName(); ?></a></h2>
<center>
