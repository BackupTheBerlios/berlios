...
//
// $Id: tos_text.php,v 1.2 2003/11/13 11:29:29 helix Exp $
?>

<p>
<h2><?php echo $sys_default_name ?> Terms of Service Agreement</h2>
</p>
...
<p>
A person's use of <?php echo $sys_default_name ?> and any of its Services (as defined below) at
any time is subject to <?php echo $sys_default_name ?> then-current Terms of Service ("TOS"),
which may be updated from time to time as set forth below. Each user can
review the then-current TOS at any time at:
<a href="http://<?php echo $sys_default_host ?>/tos/tos.php">http://<?php echo $sys_default_host ?>/tos/tos.php.</a>.  In addition, each user's use of
...
reference into the TOS.  A user's use of  <?php echo $sys_default_name ?> and/or its Services
constitutes full acceptance of and agreement to the TOS; if a user does not
accept our TOS, he or she is not granted rights to use <?php echo $sys_default_name ?> or any of
its Services, as defined herein, and should refrain from accessing
<?php echo $sys_default_name ?> and its Services.
</p>

<p>
To update the TOS or any Service-specific Rules, we will both post the
changed version and its effective date at
<a href="http://<?php echo $sys_default_host ?>/tos/tos.php">http://<?php echo $sys_default_host ?>/tos/tos.php</a>.  Concurrently with any change to the
...
<p>
<?php echo $sys_default_name ?> reserves the right at any time and from time to time to modify
or discontinue, temporarily or permanently, <?php echo $sys_default_name ?> or any Service
...
<?php echo $sys_default_name ?> shall not be liable to any user or other third party for any
such modification, suspension or discontinuance except as expressly provided
herein.
</p>

<p>
<B>2. DESCRIPTION OF SERVICE; NO WEB ACCESS</B> 
</p>

<p>
<?php echo $sys_default_name ?> is a website owned and operated by Fraunhofer FOKUS, for
...
<?php echo $sys_default_name ?> (the "Purpose").  <?php echo $sys_default_name ?> currently offers users access to a
...
thereunder.    <?php echo $sys_default_name ?> cannot and will not be liable for any loss or
...
<?php echo $sys_default_name ?> of any unauthorized use of his or her password or account or any
other breach of security and (b) ensure that he or she exits from his or her
account at the end of each session.
</p>

<p>
<?php echo $sys_default_name ?> handles user Registration Data in accordance with the
<?php echo $sys_default_name ?> Privacy Policy accessible at
<a href="http://<?php echo $sys_default_host ?>/tos/privacy.php">http://<?php echo $sys_default_host ?>/tos/privacy.php</a>.
</p>
...
that the user, and not <?php echo $sys_default_name ?>, is entirely responsible for all Content
that he or she uploads, posts, emails or otherwise transmits via <?php echo $sys_default_name ?>
or any Service. No user shall transmit Content or otherwise conduct or
participate in any activities on <?php echo $sys_default_name ?> and/or any Service which, in
the opinion of <?php echo $sys_default_name ?>'s counsel, are prohibited by law in applicable
...
<p>
<?php echo $sys_default_name ?> will not pre-screen or review Content, but <?php echo $sys_default_name ?> reserves
the right to refuse or delete any Content of which it becomes aware which it
reasonably deems not to fulfill the Purpose. In addition, <?php echo $sys_default_name ?> shall
...
otherwise illegal.  <?php echo $sys_default_name ?>, in its sole and absolute discretion, may
...
us to protect the rights, property or personal safety of <?php echo $sys_default_name ?>, its
users and the public. <?php echo $sys_default_name ?> does not control the Content posted via
the Service and, as such, does not guarantee the accuracy, integrity or
quality of such Content. Under no circumstances will <?php echo $sys_default_name ?> be liable
...
transmitted via <?php echo $sys_default_name ?> or any Service thereon.
</p>

<p>
Each user, by using <?php echo $sys_default_name ?> or any Service, may be exposed to Content
...
<?php echo $sys_default_name ?> ("Source Code") shall be subject to the OSI-approved license
applicable to such Source Code, or to such other licensing arrangements that
may be approved by <?php echo $sys_default_name ?> as applicable to such Source Code.
</p>

<p>
With respect to text or data entered into and stored by publicly-accessible
site features such as message boards and bug trackers ("<?php echo $sys_default_name ?> Public
Content"), the submitting user retains ownership of such <?php echo $sys_default_name ?> Public
...
is owned by <?php echo $sys_default_name ?>.  In each such case, the submitting user grants
<?php echo $sys_default_name ?> the royalty-free, perpetual, irrevocable, non-exclusive and
...
<p>
With respect to Content posted to private areas of <?php echo $sys_default_name ?>, i.e.,
private <?php echo $sys_default_name ?> development tools or <?php echo $sys_default_name ?> Mail, the submitting
user may grant to <?php echo $sys_default_name ?> or other users such rights and licenses as the
submitting user deems appropriate.
</p>

<p>
Content located on any <?php echo $sys_default_name ?>-hosted subdomain which is subject to the
...
such other licensing arrangements that may be approved by <?php echo $sys_default_name ?> as
...
<p>
<?php echo $sys_default_name ?> may establish general practices and limits concerning use of the
Services, as defined by posted Service-specific Rules.  While <?php echo $sys_default_name ?>
will use reasonable efforts to back up site data and make such data
available in the event of loss or deletion, <?php echo $sys_default_name ?> has no
...
by any Service. <?php echo $sys_default_name ?> reserves the right to mark as "inactive" and
archive accounts and/or projects that are inactive for an extended period of
time. <?php echo $sys_default_name ?> reserves the right to change these general practices and
...
<p>
<?php echo $sys_default_name ?>'s termination of any user's access to <?php echo $sys_default_name ?> or any Service
hereunder may be effected without notice and, on such termination,
<?php echo $sys_default_name ?> may immediately deactivate or delete user's account and/or bar
any further access to such files, that Service or <?php echo $sys_default_name ?>.  <?php echo $sys_default_name ?>
...
governmental order, <?php echo $sys_default_name ?> shall make reasonable efforts to make
...
<p>
<?php echo $sys_default_name ?>, any Service or a third party may provide links to other
Websites.  <?php echo $sys_default_name ?> exercises no control whatsoever over such other
...
materials thereon. <?php echo $sys_default_name ?> shall not be responsible or liable, directly
...
<p>
Each user shall indemnify, defend and hold harmless each of Fraunhofer FOKUS
and its affiliates and their respective officers, employees
and agents, and any of Fraunhofer FOKUS's  website partners from any and all
...
claims arising out of that user's use of <?php echo $sys_default_name ?>; his or her submission,
...
PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS AND BERLIOS ASSUMES NO
...
OF DATA WHICH RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL. BERLIOS 
...
BERLIOS MAKES NO WARRANTY THAT (i) BERLIOS OR ANY SERVICE WILL MEET
...
EXCLUDING ONLY DAMAGES ARISING OUT OF Fraunhofer FOKUS' GROSS NEGLIGENCE OR
WILLFUL MISCONDUCT, Fraunhofer FOKUS SHALL NOT BE LIABLE FOR ANY
DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES,
INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE,
DATA OR OTHER INTANGIBLE LOSSES (EVEN IF Fraunhofer FOKUS HAS BEEN ADVISED
...
MATTER RELATING TO BERLIOS OR ANY SERVICE.  IN NO EVENT SHALL Fraunhofer FOKUS TOTAL CUMULATIVE LIABILITY TO ANY USER OR OTHER PARTY UNDER THESE
...
BETWEEN Fraunhofer FOKUS AND ANY USER OR OTHER PERSON OR ENTITY NOR DO THESE
TERMS OF SERVICE EXTEND RIGHTS TO ANY THIRD PARTY.  AS NOTED ABOVE, Fraunhofer FOKUS DOES NOT AND CANNOT CONTROL THE ACTIONS OF BERLIOS USERS,
...
WE DO NOT GUARANTEE CONTINUOUS UNINTERRUPTED OR SECURE ACCESS TO BERLIOS 
...
<p>
SourceForge, the SourceForge logo and other SourceForge trademarks, service
marks, and product and service names are trademarks of VA Linux Systems Inc.
(the "SourceForge Marks").  VA Linux Systems is a trademark of VA Linux
Systems, Inc. Linux is a registered trademark of Linus Torvalds.  All other
marks are property of their respective owners.  Users may display or use the
SourceForge Marks in only in accordance with VA's Trademark Use Guidelines.
</p>
...
<p>
<?php echo $sys_default_name ?> respects the intellectual property of all parties and we ask our
...
that user or third party should provide <?php echo $sys_default_name ?> with the following
...
<?php echo $sys_default_name ?> receives such a claim, <?php echo $sys_default_name ?> reserves the right to refuse
...
<p>
The TOS constitute the entire agreement between each user and Fraunhofer FOKUS
and govern each user's use of the Service, superceding any
...
each user and Fraunhofer FOKUS shall be governed by the laws of the State of
Berlin without regard to its conflict of law provisions and each party
shall submit to the personal and exclusive jurisdiction of the courts
located within the county of Santa Clara, California. If any provision of
...
or any other matters to the <?php echo $sys_default_name ?> Support Manager at
admin@berlios.de.
</p>
...
copyrights on this page are property of their respective owners.   For
information about other Content of this page, please see the Terms of
Service governing usage of this site at <a href="http://<?php echo $sys_default_host ?>/tos/tos.php">http://<?php echo $sys_default_host ?>/tos/tos.php</a>.
For <?php echo $sys_default_name ?> privacy policy information, please see
<a href="http://<?php echo $sys_default_host ?>/tos/privacy.php">http://<?php echo $sys_default_host ?>/tos/privacy.php</a>. Content owned by Fraunhofer FOKUS is
copyright 2000-2002 Fraunhofer FOKUS.  All rights reserved.
</p>
