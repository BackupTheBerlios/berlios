...
//
// $Id: tos_text.php,v 1.1 2003/11/12 16:09:04 helix Exp $
?>
...
<p>
A person's use of SourceForge and any of its Services (as defined below) at
any time is subject to SourceForge's then-current Terms of Service ("TOS"),
which may be updated from time to time as set forth below. Each user can
review the then-current TOS at any time at:
<a href="http://sourceforge.net/tos/tos.php">http://sourceforge.net/tos/tos.php.</a>.  In addition, each user's use of
...
reference into the TOS.  A user's use of  SourceForge and/or its Services
constitutes full acceptance of and agreement to the TOS; if a user does not
accept our TOS, he or she is not granted rights to use Sourceforge or any of
its Services, as defined herein, and should refrain from accessing
SourceForge and its Services.
</p>

<p>
To update the TOS or any Service-specific Rules, we will both post the
changed version and its effective date at
<a href="http://sourceforge.net/tos/tos.php">http://sourceforge.net/tos/tos.php</a>.  Concurrently with any change to the
...
<p>
SourceForge reserves the right at any time and from time to time to modify
or discontinue, temporarily or permanently, SourceForge or any Service
...
SourceForge shall not be liable to any user or other third party for any
...
thereunder.    SourceForge cannot and will not be liable for any loss or
...
SourceForge of any unauthorized use of his or her password or account or any
...
SourceForge Privacy Policy accessible at
<a href="http://sourceforge.net/tos/privacy.php">http://sourceforge.net/tos/privacy.php</a>.
</p>
...
that the user, and not SourceForge, is entirely responsible for all Content
that he or she uploads, posts, emails or otherwise transmits via SourceForge
or any Service. No user shall transmit Content or otherwise conduct or
participate in any activities on SourceForge and/or any Service which, in
the opinion of SourceForge's counsel, are prohibited by law in applicable
...
<p>
SourceForge will not pre-screen or review Content, but SourceForge reserves
the right to refuse or delete any Content of which it becomes aware which it
reasonably deems not to fulfill the Purpose. In addition, SourceForge shall
...
otherwise illegal.  SourceForge, in its sole and absolute discretion, may
...
us to protect the rights, property or personal safety of SourceForge, its
users and the public. SourceForge does not control the Content posted via
the Service and, as such, does not guarantee the accuracy, integrity or
quality of such Content. Under no circumstances will SourceForge be liable
...
transmitted via SourceForge or any Service thereon.
</p>

<p>
Each user, by using SourceForge or any Service, may be exposed to Content
...
SourceForge ("Source Code") shall be subject to the OSI-approved license
applicable to such Source Code, or to such other licensing arrangements that
may be approved by SourceForge as applicable to such Source Code.
</p>
...
is owned by SourceForge.  In each such case, the submitting user grants
SourceForge the royalty-free, perpetual, irrevocable, non-exclusive and
...
<p>
With respect to Content posted to private areas of SourceForge, i.e.,
private SourceForge development tools or SourceForge Mail, the submitting
user may grant to SourceForge or other users such rights and licenses as the
submitting user deems appropriate.
</p>

<p>
Content located on any SourceForge-hosted subdomain which is subject to the
...
such other licensing arrangements that may be approved by SourceForge as
...
<p>
SourceForge may establish general practices and limits concerning use of the
Services, as defined by posted Service-specific Rules.  While SourceForge
will use reasonable efforts to back up site data and make such data
available in the event of loss or deletion, SourceForge has no
...
by any Service. SourceForge reserves the right to mark as "inactive" and
archive accounts and/or projects that are inactive for an extended period of
time. SourceForge reserves the right to change these general practices and
...
<p>
SourceForge's termination of any user's access to SourceForge or any Service
hereunder may be effected without notice and, on such termination,
SourceForge may immediately deactivate or delete user's account and/or bar
any further access to such files, that Service or SourceForge.  SourceForge
...
governmental order, SourceForge shall make reasonable efforts to make
...
<p>
SourceForge, any Service or a third party may provide links to other
Websites.  SourceForge exercises no control whatsoever over such other
...
materials thereon. SourceForge shall not be responsible or liable, directly
...
<p>
Each user shall indemnify, defend and hold harmless each of VA Linux
Systems, Inc. and its affiliates and their respective officers, employees
and agents, and any of VA Linux System's  website partners from any and all
...
claims arising out of that user's use of SourceForge; his or her submission,
...
PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS AND SOURCEFORGE ASSUMES NO
...
OF DATA WHICH RESULTS FROM THE DOWNLOAD OF ANY SUCH MATERIAL.  SOURCEFORGE
...
SOURCEFORGE MAKES NO WARRANTY THAT (i) SOURCEFORGE OR ANY SERVICE WILL MEET
...
EXCLUDING ONLY DAMAGES ARISING OUT OF VA LINUX SYSTEMS' GROSS NEGLIGENCE OR
WILLFUL MISCONDUCT, VA LINUX SYSTEMS, INC. SHALL NOT BE LIABLE FOR ANY
DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES,
INCLUDING BUT NOT LIMITED TO DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE,
DATA OR OTHER INTANGIBLE LOSSES (EVEN IF VA LINUX SYSTEMS HAS BEEN ADVISED
...
MATTER RELATING TO SOURCEFORGE OR ANY SERVICE.  IN NO EVENT SHALL VA LINUX
SYSTEMS' TOTAL CUMULATIVE LIABILITY TO ANY USER OR OTHER PARTY UNDER THESE
...
BETWEEN VA LINUX SYSTEMS AND ANY USER OR OTHER PERSON OR ENTITY NOR DO THESE
TERMS OF SERVICE EXTEND RIGHTS TO ANY THIRD PARTY.  AS NOTED ABOVE, VA LINUX
SYSTEMS DOES NOT AND CANNOT CONTROL THE ACTIONS OF SOURCEFORGE USERS,
...
WE DO NOT GUARANTEE CONTINUOUS UNINTERRUPTED OR SECURE ACCESS TO SOURCEFORGE
...
<p>
SourceForge respects the intellectual property of all parties and we ask our
...
that user or third party should provide SourceForge with the following
...
SourceForge receives such a claim, SourceForge reserves the right to refuse
...
<p>
The TOS constitute the entire agreement between each user and VA Linux
Systems, Inc. and govern each user's use of the Service, superceding any
...
each user and VA Linux Systems shall be governed by the laws of the State of
California without regard to its conflict of law provisions and each party
...
or any other matters to the SourceForge Support Manager at
...
Service governing usage of this site at <a href="http://sourceforge.net/tos/tos.php">http://sourceforge.net/tos/tos.php</a>.
For SourceForge privacy policy information, please see
<a href="http://sourceforge.net/tos/privacy.php">http://sourceforge.net/tos/privacy.php</a>. Content owned by VA Linux Systems is
